...
class LoginFrame(Frame):
    ...
    def __init__(self, master):
        ...
        self.E9.place(x = 700,y = 300)

        self.E10 = Label(top, text = output[3])
        self.E10.place(x = 500,y = 300)


        self.E11 =Label(top, text = output[4])
        self.E11.place(x = 700,y = 350)
        
        self.E12 = Label(top, text = output[5])
        self.E12.place(x = 500,y = 350)
        ...
        lb = Listbox(self.frame, width=30, height=20)
        lb.pack(side = 'left',fill = 'y' )

        self.scrollbar = Scrollbar(self.frame, orient="vertical",command=lb.yview)
